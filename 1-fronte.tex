...
\vspace*{-2.4cm}
\hspace*{-2.65cm}\includegraphics[width=138mm]{./MI_BALLESTER_NOITE_ABERTURA.png}  
\end{textblock*}
\clearpage
\pagebreak
...
\begin{textblock*}{2.625in}(0pt,0pt)%
\vspace*{-2.4cm}
\hspace*{-2.3cm}\includegraphics[width=138mm]{./MI_BALLESTER_NOITE_ABERTURA.png}  
\end{textblock*}
\clearpage
